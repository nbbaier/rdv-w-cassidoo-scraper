				...
				<div className="flex gap-2 items-center">
					...
					<div className="flex gap-1.5 items-center">
						<Input
							...
							className="text-sm h-9 w-10 sm:w-10 px-1.5 sm:px-2 text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
						/>
